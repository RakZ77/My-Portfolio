  ...
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 px-6 py-12 sm:px-10 md:px-16 lg:px-32 md:py-20">
      <div className="w-full md:w-auto text-center md:text-left">
        ...
        {/* Download CV Button */}
        <button className="flex items-center gap-2 bg-blue-200 text-black font-inter body-1 px-4 py-2 rounded-xl hover:bg-blue-300 dark:bg-sky-600 dark:text-slate-900 dark:hover:bg-sky-500">
          <Download size={20}/>
          Download CV
          </button>
      </div>
